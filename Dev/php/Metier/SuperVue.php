...
/**
 * Bonus de type super vue
 * @type {type}
 */
class SuperVue extends Bonus {
    ...
    public function AppliquerEffet($joueur){
        if(!$joueur->SousBonus()){          //On fait en sorte ici qu'on ne puisse pas cumuler les effets
            $joueur->AppliquerBonus(60);    //On lance le timer du côté du joueur pour la durée de l'effet
            $joueur->ObtenirSuperVue();     //On applique l'effet
        }
    }
}